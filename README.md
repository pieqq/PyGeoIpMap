...
An example of a CVS file with each IP address' latitude and longitude values provided:
...
The World map can be generated from the CVS file by running the following command:
